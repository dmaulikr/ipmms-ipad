...
- (void) generateData
{
    if (populationOnProgress==NO)
    {
        ...
        METHODCALLBACK l_locationListReturn = ^(NSDictionary *p_dictInfo)
        {
            [self locationListDataGenerated:p_dictInfo];
        };
        [[gymWSProxy alloc] initWithReportType:_webdataName andInputParams:nil andReturnMethod:l_locationListReturn];
    }    
}
